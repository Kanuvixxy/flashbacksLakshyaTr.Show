class Start {
  ...
  display() {
    ...
    this.buttonOP1.position(windowWidth / 2 + 130, windowHeight / 2 - 20);
    this.buttonOP2.position(windowWidth / 2 - 270, windowHeight / 2 + 130);
    this.buttonOP3.position(windowWidth / 2 + 130, windowHeight / 2 + 130);
    ...
    textSize(60);
    textFont(font);
    text("FLASHBACKS", windowWidth / 2 - 160, windowHeight / 4 - 160);
    textSize(40);
    text("Choose Your Era:", windowWidth / 2 - 130, windowHeight / 2 - 100);
    textSize(40);
